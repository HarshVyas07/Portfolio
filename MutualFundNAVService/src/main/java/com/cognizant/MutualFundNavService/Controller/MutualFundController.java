package com.cognizant.MutualFundNavService.Controller;
...
import com.cognizant.MutualFundNavService.Service.MutualFundService;
...
public class MutualFundController {
	...
	@GetMapping("/dailyMutualFundNav/byName/{mutualFundName}")
