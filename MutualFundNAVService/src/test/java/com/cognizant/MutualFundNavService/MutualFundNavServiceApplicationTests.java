...
import com.cognizant.MutualFundNavService.Controller.MutualFundController;
...
class DailyMutualFundNAVApplicationTests {
    ...
    public void testGetAllDailySharePrice() throws Exception {
        ResultActions actions = mvc.perform(get("/dailyMutualFundNav/byName/Axis Bluechip fund"));
        actions.andExpect(status().isOk());
